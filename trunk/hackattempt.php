...
<?php
    ...
    $_SESSION['ERROR']['reason'] = "An Attempt to Hack the System has been detected.|Your account may be deactivated by the admin.|Please be fair to the judging System.";
?>
