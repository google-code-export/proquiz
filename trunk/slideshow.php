...
<script type="text/javascript">
    window.total_question = <?php echo $_SESSION['STATS']['DETAILS']['total_qstn'] ?>;
</script>
...
<div id="wrapper">
	...
	<div id="headerResults"><span><?php echo $_GET['instid']; ?></span></div>
	...
	<div id="content">
     ...
     <div class="cntHolder">
      ...
      <!-- End Results -->
        ...
        <div class="pq_ft"> 
                <div id="ss_next"  class="pq_btn"><a href="#Next">Next</a></div>
                <div id="ss_reset"  class="pq_btn"><a href="#Reset">Reset</a></div>
                <div  class="pq_btn"><a href="quiz_menu.php" target="_self">Exit</a></div>
                <div id="ss_prev"  class="pq_btn"><a href="#Previous">Previous</a></div>
            </div>
	</div>    <!-- content End -->
